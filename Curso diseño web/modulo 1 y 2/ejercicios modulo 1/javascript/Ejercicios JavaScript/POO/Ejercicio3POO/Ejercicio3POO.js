...
function descuentos(entrada,listaRangos){
        entrada.forEach(producto => {
            rangos.forEach(rango => {
                if(producto.precio>=rango.min && producto.precio<=rango.max){
                    producto.descuento=rango.desc;
                    productos[i].precio=productos[i].precio*(1 - productos[i].descuento/100);
              }
            });
