...
public class GTree<E> extends Tree<E> implements GTreeIF<E> {
	...
	private ListIF<GTreeIF<E>> children; //te devuelve una lista de los subarboles nodo
	...
	public void addChild(int pos, GTreeIF<E> e) {//coge el subarbol y lo mete en el arbol principal
